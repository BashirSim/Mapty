...
class App {
    ...
    _newWorkout(e) {
        //(...inputs) creates an array loops over the array and check if the valuse are postives
        ...
        const distance = +inputDistance.value; // "+" sign to convert the value from strings to numbers
